import{aH as w,az as f,aI as _,N as q,x as y,aJ as g,aK as x,aL as z,aM as E}from"./modules/unplugin-icons-BGjEH5hM.js";import{o as L,b as R,w as B,j as o,g as s,d as t,E as r,v as T,x as j,A as l}from"./modules/vue-hRFCVXKJ.js";import{I as C}from"./default-DK8CBICn.js";import{_ as I,u as M,f as V}from"./index-ndxBl781.js";import"./modules/shiki-BCPDLLIJ.js";const A={class:"s-cqrs-meta"},S={class:"s-cqrs"},h={class:"s-cqrs-client"},W={class:"s-cqrs-node node-command"},P={class:"s-cqrs-node node-store"},G={class:"s-cqrs-node node-bus"},H={class:"s-cqrs-node node-query"},N={class:"s-cqrs-node node-readmodel"},Y={class:"s-cqrs-node node-projector"},O={__name:"10-complex-schemas.md__slidev_92",setup(F){const{$clicksContext:a,$frontmatter:i}=M();return a.setup(),(K,e)=>{const d=w,n=f,p=_,c=q,u=y,m=g,v=x,b=z,k=E;return L(),R(C,T(j(l(V)(l(i),91))),{default:B(()=>[o(`
